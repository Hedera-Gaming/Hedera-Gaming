...
export class GameplayScene extends BaseScene implements Resizable {
    ...
    create(): void {
        ...
        this.addRepeatingAction(
            ...
            .addRepeatingAction(
                ...
                (time: number, delta: number) => {
                    const activeEnemies = SpaceSimClient.opponents.filter(
                        (o) => o?.ship?.active
                    );
    ...
    private _createBackground(): void {
        ...
        this._backgroundStars.setDepth(
            SpaceSimClient.Constants.UI.Layers.BACKGROUND
        );
                ...
                this.physics.add.collider(o, this.playerShip, () => {
                    if (o?.active && this.playerShip?.active) {
                        const collisionSpeed = o.body.velocity
                            ...
                            .length();
                        const damage =
                            collisionSpeed / SpaceSim.Constants.Ships.MAX_SPEED; // maximum damage of 1
