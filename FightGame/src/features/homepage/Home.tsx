...
import { SpaceFightersLogo } from '@/shared/components/SpaceFightersLogo';
...
const Home = () => {
  ...
  const stats = [
    { icon: <Users />, label: 'Active Players', value: '20+' },
    { icon: <Coins />, label: 'NFTs Minted', value: '100+' },
    { icon: <TrendingUp />, label: 'Trading Volume', value: '$2M' },
  ];
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Why HedraSpace?</h2>
