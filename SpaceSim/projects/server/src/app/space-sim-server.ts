...
export namespace SpaceSimServer {
    ...
    export namespace Constants {
        ...
        export namespace Map {
            ...
            export const MAP_OPTIONS: GameLevelOptions = {
                seed: 'Hedera-Gaming', // Seed aléatoire basé sur le temps seed: Date.now().toString() // Ou seed aléatoire avec Math.random seed: Math.random().toString() // Ou un UUID unique seed: Phaser.Math.RND.uuid()
